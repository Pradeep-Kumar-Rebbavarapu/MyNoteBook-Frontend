...
class MyObtainTokenPairView(TokenObtainPairView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if access is not None:
            ...
            response.set_cookie('token', access, httponly=True,samesite='None', secure=True,expires=datetime.datetime.now() + datetime.timedelta(days=2))
            response.set_cookie('refresh', refresh, httponly=True,samesite='None', secure=True,expires=datetime.datetime.now() + datetime.timedelta(days=2))
            response.set_cookie('email', email, httponly=True,samesite='None', secure=True,expires=datetime.datetime.now() + datetime.timedelta(days=2))
            response.set_cookie('username',username, httponly=True,samesite='None', secure=True,expires=datetime.datetime.now() + datetime.timedelta(days=2))
            return response
